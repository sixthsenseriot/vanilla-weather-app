...
function displayWeather(response) {
  ...
  if (response.data.weather[0].main == "Snow") {
    if (
      response.data.weather[0].discription == "sleet" ||
...
function displayFahrenheitTemperature(event) {
  ...
  dayOneTemp.innerHTML = `${Math.round(fahrenOneA)}° | ${Math.round(
    fahrenOneB
  )}°`;
  dayTwoTemp.innerHTML = `${Math.round(fahrenTwoA)}° | ${Math.round(
    fahrenTwoB
  )}°`;
  dayThreeTemp.innerHTML = `${Math.round(fahrenThreeA)}° | ${Math.round(
    fahrenThreeB
  )}°`;
  dayFourTemp.innerHTML = `${Math.round(fahrenFourA)}° | ${Math.round(
    fahrenFourB
  )}°`;
  dayFiveTemp.innerHTML = `${Math.round(fahrenFiveA)}° | ${Math.round(
    fahrenFiveB
  )}°`;
}
